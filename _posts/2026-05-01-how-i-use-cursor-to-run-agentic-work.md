---
layout: post
title: "How I Use Cursor to do Agentic Operations"
date: 2026-05-01
description: "A practical guide to using Cursor for project-based agentic work, from planning and subagents to MCP validation and recovery."
---
...
Cursor is an AI-native IDE, used primarily for software development. If you do not spend your days surrounded by engineers, an IDE is basically the place where the files, tools, and agent workflows all live together.

<figure>
  <img src="/final-images/cursor-window-source-cursor.com.webp" alt="Cursor workspace showing the editor, file tree, and agent sidebar" loading="lazy" />
  <figcaption>Cursor showing the editor, project files, and agent panel living in one workspace. Source: <a href="https://cursor.com/">cursor.com</a>.</figcaption>
</figure>
...
<figure>
  <img src="/final-images/certification-101-introduction.png" alt="Overview of the finished certification program" loading="lazy" />
  <figcaption>One screen from the finished certification program: 21 modules across the 101, 201, and 301 tracks.</figcaption>
</figure>
...
<div class="prompt-block reveal">
  <div class="prompt-block-header">
    <div class="prompt-block-icon"></div>
    <span class="prompt-block-label">AGENTS.md starter instructions</span>
    <button class="prompt-block-copy" onclick="copyBlock(this)">Copy</button>
  </div>
  <pre>## Start Here - Every Session

Before starting any task:
1. Read `USER.md` (a doc on Jenny's work preferences)
2. Check whether the appropriate project folder already exists, if it does not, create a folder for the project including a README, .agents/, work/, outputs/, and context/ folder. 
...
- Log any meaningful choice in `decisions.md`</pre>
</div>
...
<div class="stat-callout reveal">
  <div class="stat-number">56-112</div>
  <div class="stat-label">
    <strong>Agent review passes per module</strong>
    Before a module came back to me, it had already gone through multiple reviewer, synthesis, and revision rounds.
  </div>
</div>
